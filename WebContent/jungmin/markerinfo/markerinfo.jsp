                 ...
                 <div class="product_info">
                  <div class="info">
                    ...
                    <div class="prodleft">
                      <div class="imges">
                        <ul>
                          <li><img src="${cp}/images/mm1-1.jpg" alt=""></li>
                      ...
                      <div class="thumb">
                        ...
                        <div class="thum_list">
                          <ul>
                            <li><a><img src="${cp}/images/mm1-1.jpg" alt=""></a></li>
                    ...
                    <div class="p_info">
                        ...
                        <ol>
                          <li>
                            - 펌핑이 필요 없는 필터타입으로 깔끔한 표기가 가능한 수성 안료 퍼머넌트 마카<br> - 철제,플라스틱,유리,나무,가죽,종이 등 다양한 곳에 사용 가능<br> - 어두운 곳에 사용하기 좋으며 건조 후에는 지속력이 뛰어남<br><br> 1,12000원
                          </li>
                        </ol>                    
                      </div>
                      <div class="ink">
                        ...
                        <div class="color_list">
                          <ul>
                            <li><img src="${cp}/images/wb0.jpg" alt=""></li>
                      ...
                      <div class="download">
                        ...
                        <div class="buy">
                          <a href=""><img src="${cp}/images/buynow.gif" alt=""></a>
                        </div>
                    
                </div>
            </div>
            <div class="view_list"><a href="${cp}/pen/penpage.jsp">LIST</a></div>                       
