	...
	<div id="header">
		<div class="head">
							...
							<c:choose>
								<c:when test="${loginUser.user_id!=null}">
									<li><span>${loginUser.user_id} 님 환영합니다.</span>&nbsp;&nbsp;
										<a href="${cp}/jungmin/usermodify.mo">MYPAGE</a>&nbsp; <a
										href="${cp}/user/UserLogoutOk.us">LOGOUT</a></li>
								</c:when>
								<c:otherwise>
			...
			<div class="gnb">
				<div class="conwrap">
					<h1>
						<a href="${cp}/index.jsp"><img
							src="${cp}/images/logo.jpeg" alt="" /></a>
					</h1>
					<div class="nav">
						<ul>
							<li><a href="${cp}/kyungchul/ceo.jsp">모나미소개</a>
								<ul>
									...
									<li><a href="${cp}/kyungchul/company.jsp">회사연혁</a></li>
									<li><a href="${cp}/geunseok/investment.jsp">투자정보</a></li>
									<li><a href="${cp}/geunseok/ci.jsp">CI</a></li>
									<li><a href="http://recruit.monami.co.kr/">채용정보</a></li>
									<li><a href="${cp}/geunseok/location.jsp">찾아오시는 길</a></li>
								</ul></li>
							<li><a href="${cp }/jungmin/pen/penpage.mo">모나미제품</a>
								<ul>
							...
							<li><a href="${cp}/teamin/monami_news1.jsp">NEWS & VIDEO</a>
								<ul>
							...
							<li><a href="${cp}/doyoon/FAQ.jsp">고객지원</a>
								<ul>
					...
					<div class="search">
						...
						<div class="nav_search">
							<input type="text" name="" id="" /> <a
								href="${cp}/kyungchul/search.jsp"> <img
		...
		<div id="contents">
			...
			<div class="submenu_list">
				<ul id="sublist">
					...
					<li><a href="${cp}/doyoon/A_main1.jsp">미술용품</a></li>
					<li><a href="${cp}/doyoon/E_main1.jsp">기타</a></li>
					<li class="on"><a href="${cp}/jungmin/cataloguepage.mo">카탈로그</a>
					</li>
				</ul>
			</div>
			<h3 class="title1">CATARLOGUE</h3>


			<div class="product_list">
				<ul>
					<li><a href="${cp}/images/2021 국내 카달로그 최종_optimize.pdf"
						download="">
					...
					<li><a href="${cp}/images/2020 국내 카달로그_optimize.pdf"
						download="">
							<div class="thum">
			...
			<div class="pagenum">
				<a class="page_prev"> <img src="${cp}/images/page_prev.gif">
				</a> <strong>1</strong> <a class="page_next"> <img
					src="${cp}/images/page_next.gif">
				</a>
			</div>
			<div class="topbtn">
        ...
        개인정보취급방침 시행일자 : 2018년 08월 02일 
				...
				<div class="email" style="display: none;">
					...
					<div class="textarea">
						...
						거부하며, 이를 위반시정 보통신망법에 의해 형사 처벌됨을 유념하시기 바랍니다. <br>
						<br>
			...
			<div class="foot_btm">
				<div class="info">
					...
					<address>
						ADDRESS : 경기도 용인시 수지구 손곡로 17 <span>l</span> TEL : 031-216-0153 <span>l</span>
						FAX : 031-270-5154
					</address>
					<p class="copy">COPYRIGHT(C) 2017 MONAMI.CO.,LTD. ALL RIGHTS
						RESERVED.</p>
				</div>
				<div class="cc">
				...
				<div class="fam_site">
					<a>FAMILY SITE</a>
					<ul>
						<li><a href="#" target="_blank">모나미몰</a></li>
						<li><a href="#" target="_blank">모나르떼</a></li>
						<li><a href="#" target="_blank">모나미 컨셉스토어</a></li>
						<li><a href="#" target="_blank">주식회사 항소</a></li>
						<li><a href="#" target="_blank">모나미 스테이션</a></li>
						<li><a href="#" target="_blank">모나미 미술대회</a></li>
						<li><a href="#" target="_blank">모나미 기업서비스</a></li>
						<li><a href="#" target="_blank">모나미코스메틱</a></li>
					</ul>
				</div>
			</div>
		</div>
