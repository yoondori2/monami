...
<c:set var="cp" value="${pageContext.request.contextPath}"/>
    ...
    <div id="container">
        <div class="contents">
            ...
            <div class="bbs_gall">
                <ul>
                    <li data-idx="125">
                        <a>
                            <div class="thumarea">
                                <img src="${cp}/monami_images/b_file_25.jpg" alt="" width="335" height="188">
                                <div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[60주년 데스크펜] 모나미 이러기 있어? 아니, 1억이 있어!_타이포그래픽</div>
                    ...
                    <li data-idx="124">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_26.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[60주년 데스크펜] 모나미에게 애정을 주신 모든 분들 주목!_범퍼애드(15..</div>
				<div class="date">2020.12.22</div>
                            </div>
                        </a>
                    </li>
                    <li data-idx="123">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_27.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[9회말2아웃] 남사친이 여자로 보이기 시작했다_EP06 9회말2아웃 - 너여야..</div>
				<div class="date">2020.08.14</div>
                    ...
                    <li data-idx="122">
                        <a>
                            <div class="thumarea">		
                                <img src=".${cp}/monami_images/b_file_28.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[9회말2아웃] 남녀가 생일 같으면 생기는 일_EP05 파울 - 마음에 드는 선..</div>
				<div class="date">2020.08.07</div>
                    ...
                    <li data-idx="121">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_29.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[9회말 2아웃] 썸 단계에서 커플템 가능?_EP04 기습번트 - 갑작스런 고백</div>
				<div class="date">2020.07.31</div>
                    ...
                    <li data-idx="120">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_30.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[9회말 2아웃] 썸남이 분위기 잡을때_EP03 보크 - 견제가 필요한 순간</div>
                    ...
                    <li data-idx="119">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_31.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[9회말 2아웃] 남사친 만드는 방법_EP02 플레이볼 - 아싸가 동아리 가입하..</div>
                    ...
                    <li data-idx="118">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_32.png" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[9회말2아웃] 자강두천! 모든 것을 뚫는 창 VS 모든 것을 막는 방패_EP01 ..</div>
                    ...
                    <li data-idx="117">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_33.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[9회말2아웃] 속보! 연제대 야구 동아리 증발 위기!_Teaser</div>
                    ...
                    <li data-idx="116">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_34.png" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[손그림 그리기] 서울그리기 랜드마크편 - 서울역</div>
                    ...
                    <li data-idx="115">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_35.png" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[어반스케치] 집에서 컬러 리얼 브러쉬와 떠나는 여행_사람</div>
				                <div class="date">2020.07.01</div>
                            </div>
                        </a>
                    </li>
                    <li data-idx="114">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_36.png" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[어반스케치] 집에서 컬러 리얼 브러쉬와 떠나는 여행_시골</div>
				                <div class="date">2020.07.01</div>
                            </div>
                        </a>
                    </li>
            ...
            <div class="paging">
                <a href="${cp}/teamin/monami_video2.jsp" class="page_prev">
                ...
                <a href="${cp}/teamin/monami_video4.jsp" class="page_next">
