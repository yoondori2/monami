...
<c:set var="cp" value="${pageContext.request.contextPath}"/>
    ...
    <div id="container">
        <div class="contents">
            ...
            <div class="bbs_gall">
                <ul>
                    <li data-idx="125">
                        <a>
                            <div class="thumarea">
                                <img src="${cp}/monami_images/b_file_37.jpg" alt="" width="335" height="188">
                                <div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[마이하비이즈] 달콤한 커플 잼 병 꾸미기</div>
                    ...
                    <li data-idx="124">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_38.png" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[어반스케치] 집에서 컬러 리얼 브러쉬와 떠나는 여행_해변</div>
				                <div class="date">2020.07.01</div>
                            </div>
                        </a>
                    </li>
                    <li data-idx="123">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_39.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">당신의 마음을 선물하세요- 아버지편</div>
                    ...
                    <li data-idx="122">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_40.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">당신의 마음을 선물하세요- 은사님편</div>
                    ...
                    <li data-idx="121">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_41.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[사용법] 컬러 리얼 브러쉬의 모든 것</div>
				                <div class="date">2020.05.12</div>
                            </div>
                        </a>
                    </li>
                    <li data-idx="120">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_42.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[손그림 그리기] 서울그리기 랜드마크편 - 여의도</div>
				                <div class="date">2020.05.12</div>
                            </div>
                        </a>
                    </li>
                    <li data-idx="119">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_43.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[손그림 그리기] 서울그리기 랜드마크편 - 대오서점</div>
				                <div class="date">2020.05.12</div>
                            </div>
                        </a>
                    </li>
                    <li data-idx="118">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_44.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[60 anniversary] 60주년 기념 프러스펜 3000 데스크펜</div>
				                <div class="date">2020.05.12</div>
                            </div>
                        </a>
                    </li>
                    <li data-idx="117">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_45.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[수사반장] - EP.04 낙서 싸이코패스</div>
				                <div class="date">2020.05.12</div>
                            </div>
                        </a>
                    </li>
                    <li data-idx="116">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_46.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                                <div class="sbj">[수사반장] - EP.03 에코백 절도범</div>
				                <div class="date">2020.05.12</div>
                            </div>
                        </a>
                    </li>
                    <li data-idx="115">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_47.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[수사반장] - EP.02 캠퍼스 방화범</div>
				                <div class="date">2020.05.12</div>
                            </div>
                        </a>
                    </li>
                    <li data-idx="114">
                        <a>
                            <div class="thumarea">		
                                <img src="${cp}/monami_images/b_file_48.jpg" alt="" width="335" height="188"/>				<div class="btn_play"></div>
                            </div>
                            <div class="txtarea">
                                <div class="sbj">[수사반장] - EP.01 컨닝범의 진실</div>
				                <div class="date">2020.05.12</div>
                            </div>
                        </a>
                    </li>
            ...
            <div class="paging">
                <a href="${cp}/teamin/monami_video3.jsp" class="page_prev">
                ...
                <a href="${cp}/teamin/monami_video5.jsp" class="page_next">
