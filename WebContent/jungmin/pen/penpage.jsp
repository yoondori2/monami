  ...
  <div id="container">
    <div id="contents">
        ...
        <div class="pagenum">
         ...
         <strong>1</strong>
         <a href="${cp}/pen/penpage2.jsp">2</a>
         <a href="${cp}/pen/penpage3.jsp">3</a>
         <a href="${cp}/pen/penpage4.jsp">4</a>
         <a href="${cp}/pen/penpage5.jsp">5</a>
         <a href="${cp}/pen/penpage6.jsp">6</a>
        
         <a  class="page_next" href="${cp}/pen/penpage2.jsp"> 
