      ...
      <div id="container">
        <div id="contents">
            ...
            <ul class="categori_list">
                ...
                <li><a href="./oil_pen.jsp">유성볼펜</a></li>
                ...
                <ul>
                    ...
                    <li><a href="../peninfo/peninfo.jsp">
                        ...
                        <div class="info">
                            ...
                            <div class="product_name">153 클립</div>
                        </div>                   
                    </a>
                    </li>
                    ...
                    <li><a href="pen2">
                        ...
                        <div class="info">
                            <div class="pen_name">유성볼펜</div>
                            <div class="product_name">FX multi 700</div>
                        </div>                   
                    </a>
                    </li>
                    ...
                    <li><a href="pen3">
                        ...
                        <div class="info">
                            ...
                            <div class="product_name">153 스마트펜</div>
                        </div>                   
                    </a>
                     </li>
                    ...
                    <li><a href="pen4">
                        ...
                        <div class="info">
                            ...
                            <div class="product_name">라인 만년필</div>
                        </div>                   
                    </a>
                     </li>
                    ...
                    <li><a href="pen5">
                        ...
                        <div class="info">
                            <div class="pen_name">FX 153</div>
                            <div class="product_name">FX 153</div>
                        </div>                   
                    </a>
                 </li>
                    <li><a href="pen6">
                     ...
                     <div class="info">
                         <div class="pen_name">프리미엄펜</div>
                         <div class="product_name">153 네이쳐</div>
                     </div>                   
                    </a></li>
                    <li><a href="pen7">
                     <div class="thum">
                     ...
                     <div class="info">
                         <div class="pen_name">유성볼펜</div>
                         <div class="product_name">FX ZETA</div>
                     </div>                   
                    </a></li>
                    <li><a href="pen8">
                     <div class="thum">
                    ...
                    <li><a href="pen9">
                     ...
                     <div class="info">
                         ...
                         <div class="pen_name">프리미엄펜</div>
                         <div class="product_name">153 블라썸</div>
                     </div>                   
                    </a></li>
                     <li><a href="pen10">
                    <div class="thum">
                    ...
                    <div class="info">
                        <div class="pen_name">만년필</div>
                        <div class="product_name">153 네오 만년필 F</div>
                    </div>                   
                    </a></li>
                </ul>
            </div>
            <div class="pagenum">
             <a class="page_prev" href="./penpage.jsp">
                 <img src="../images/page_prev.gif">
             </a>
             <a href="./penpage.jsp">1</a>
             <strong>2</strong>
             <a href="./penpage3.jsp">3</a>
             <a href="./penpage4.jsp">4</a>
             <a href="./penpage5.jsp">5</a>
             <a href="./penpage6.jsp">6</a>
          
             <a  class="page_next" href="./penpage3.jsp">
