...
<body>
    ...
    <div id="container">
      ...
      <div class="product_list">
        <ul>
          <li>
            <a href="${cp}/doyoon/E_detail1.jsp">
              <div class="thum">
              ...
              <div class="info">
                <div class="cate1">수정테이프</div>
                <div class="product_name">스윕</div>
              </div>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="#">
              ...
              <div class="info">
                <div class="cate1">NOTE</div>
                <div class="product_name">지퀀스</div>
              </div>
            </a>
          </li>
          <li>
            <a href="#">
              ...
              <div class="info">
                ...
                <div class="product_name">클리키</div>
              </div>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="#">
              ...
              <div class="info">
                <div class="cate1">모니주 어린이 문구 선물세트</div>
                <div class="product_name">모니주 어린이 문구 선물세트</div>
              </div>
            </a> 
          </li>
        </ul>
    ...
    <div class="paging">
      ...
      <span>1</span>
      <a href="${cp}/doyoon/E_main2.jsp">2</a>
