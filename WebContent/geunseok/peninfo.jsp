                 ...
                 <div class="product_info">
                  <form class="info" name="toBasketForm" method="post" action="${cp}/product/Basket.pd">
                    ...
                    <div class="p_info">
                        ...
                        <ol>
                          <li>
                            - 미끄러움을 방지하고 편안한 그립감을 제공하는 패턴 그립<br> - 실리콘 파트 구조를 적용하여 노크 소을음 최소화한 디자인<br> - 유격을 최소화하여 흔들림 없이 안정감 있는 필기감을 제공<br><br> ${product.prod_price}원
                          </li>
                        </ol>                    
                      </div>
                      <div class="ink">
                        ...
                        <div class="color_list">
                          <ul>
                            <li><img src="${cp}/images/ic1.jpg" alt=""></li>
                            <li><img src="${cp}/images/ic2.jpg" alt=""></li>
                            <li><img src="${cp}/images/ic3.jpg" alt=""></li>
                          </ul>
                        </div>
                      </div>
                      <div class="body_color">
                        ...
                        <div class="color_list">
                          <ul>
                            <li><img src="${cp}/images/bc1.jpg" alt=""></li>
                            <li><img src="${cp}/images/bc2.jpg" alt=""></li>
                            <li><img src="${cp}/images/bc3.jpg" alt=""></li>
                            <li><img src="${cp}/images/bc4.jpg" alt=""></li>
                            <li><img src="${cp}/images/bc5.jpg" alt=""></li>
                            <li><img src="${cp}/images/bc6.jpg" alt=""></li>
                          </ul>
                        </div>
                      </div>
                      <div class="point">
                      ...
                      <div class="nib_type">
                        ...
                        <ul>
                          <li><img src="${cp}/images/nt1.jpg" alt=""></li>
                        </ul>
                      </div>
                      <div class="download">
                        ...
                        <div class="down">
                          <ul>
                            <li><a href="${cp}/images/pinfo셀.pdf" download="">
                              <img src="${cp}/images/s1.gif" alt="">셀시트
                            </a></li>
                            <li><a href="${cp}/images/peninfo상세.jpg" download="">
                              <img src="${cp}/images/s2.gif" alt="">제품상세
                            </a></li>
                            <li><a href="${cp}/images/peninfo이미지.zip" downloda="">
                              <img src="${cp}/images/s3.gif" alt="">이미지
                            </a></li>
                          </ul>
                        </div>
                	</div>                   
